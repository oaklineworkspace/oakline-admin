...
async function sendViaResend({ to, subject, html, text, from }) {
  ...
  let verifiedFromAddress = from;
  if (!from.includes('@theoaklinebank.com')) {
    console.warn(`⚠️ FromAddress ${from} is not on verified domain. Using info@theoaklinebank.com`);
