...
// Using environment-based email addresses

const getEmailDomain = () => process.env.BANK_EMAIL_DOMAIN || 'theoaklinebank.com';

export const EMAIL_ADDRESSES = {
  INFO: process.env.EMAIL_INFO || `info@${getEmailDomain()}`,
  SUPPORT: process.env.EMAIL_SUPPORT || `support@${getEmailDomain()}`, 
  ADMIN: process.env.EMAIL_ADMIN || `admin@${getEmailDomain()}`,
  FINANCE: process.env.EMAIL_FINANCE || `finance@${getEmailDomain()}`
};
